...
insert into messages(issue_id, text, created_at, updated_at) values (1, "message1", CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into messages(issue_id, text, created_at, updated_at) values (1, "message2", CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into messages(issue_id, text, created_at, updated_at) values (2, "message3", CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
insert into messages(issue_id, text, created_at, updated_at) values (3, "message4", CURRENT_TIMESTAMP(),  CURRENT_TIMESTAMP());
